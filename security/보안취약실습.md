...
<div style="text-align: center; margin: 20px 0;">
  <img src="{{ 'security/images/innerHTML_hack.png' | relative_url }}" 
       alt="innerHTML취약점 확인" 
       style="max-width: 80%; height: auto; border: 1px solid #ddd; border-radius: 5px;">
  <p style="font-size: 0.9em; color: #666;">[innerHTML취약점 확인]</p>
</div>

<div style="text-align: center; margin: 20px 0;">
  <img src="{{ '/security/images/innerHTML_secure_check.png' | relative_url }}" 
       alt="innerHTML취약점 보완 완료" 
       style="max-width: 80%; height: auto; border: 1px solid #ddd; border-radius: 5px;">
  <p style="font-size: 0.9em; color: #666;">[innerHTML취약점 보완 완료]</p>
</div>
---
